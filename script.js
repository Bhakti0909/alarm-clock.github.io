...
const alarmSound = new Audio("ringtone.mp3"); // Replace 'path_to_alarm_sound.mp3' with the actual path to your alarm sound file
...
function getInputs(e) {
  ...
  const alarmTime = convert12hrto24hr(hourVal, minVal, secondVal, ampmVal);
  setAlarm(alarmTime);
}
...
// This function adds the alarm set by the user in the form of a list along with a delete button
